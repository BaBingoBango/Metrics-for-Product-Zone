...
/// The entry point for the watchOS app. Although it has no tabs, it shares the name of the iOS entry point file. It is the main view for the watch app, holding the Log button and the day's stats.
